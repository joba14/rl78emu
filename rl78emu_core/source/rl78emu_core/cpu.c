...
uint20_t short_direct_address_to_absolute_address(const uint8_t address)
{
	...
	rl78emu_misc_debug_assert((short_direct_addressing_start + address) < \
...
uint20_t special_function_register_to_absolute_address(const uint8_t address)
{
	...
	rl78emu_misc_debug_assert((special_function_register_start + address) < \
...
uint20_t general_purpose_register_to_absolute_address(const uint8_t offset)
{
	...
	rl78emu_misc_debug_assert(offset < general_purpose_register_count_per_bank);
	...
	rl78emu_misc_debug_assert((general_purpose_register_start + address) < \
...
uint20_t direct_address_to_absolute_address(const uint8_t address_low, const uint8_t address_high)
{
	...
	// +---+---+---+---+-----+-----+-----+-----+      +-----+-----+-----+-----+
	const uint20_t absolute_address = ((address_low & 0xFF) << 0) | ((address_low & 0xFF) << 8) | ((es_value & 0x0F) << 16);
	return absolute_address;
}
