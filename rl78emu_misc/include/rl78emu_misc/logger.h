...
#ifndef __rl78emu_misc__include__rl78emu_misc__logger_h__
#define __rl78emu_misc__include__rl78emu_misc__logger_h__
 ...
 * @param ...    arguments of the log
 */
void rl78emu_misc_logger_error(
	const char_t* const format,
	...) __attribute__ ((format (printf, 1, 2)));
