...
#ifndef __rl78emu_misc__include__rl78emu_misc__debug_h__
#define __rl78emu_misc__include__rl78emu_misc__debug_h__
 ...
 * 
 * @note It abstracts the @ref rl78emu_misc_debug_assert_impl function and passes line,
 * file, and stringified expression to the implementation function.
 */
#	define rl78emu_misc_debug_assert(_expression)                              \
		rl78emu_misc_debug_assert_impl(                                        \
			_expression,                                                       \
			#_expression,                                                      \
 ...
 * file, and stringified expression to the implementation function.
 */
#	define rl78emu_misc_debug_assert(_expression) ((void)(_expression))
#endif
